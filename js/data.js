...
int countAdjacentMines(int row, int col) {
    int count = 0;
    int dr[] = {-1, -1, -1, 0, 0, 1, 1, 1}; // 行偏移
    int dc[] = {-1, 0, 1, -1, 1, -1, 0, 1}; // 列偏移
...
int revealCell(int row, int col) {
    ...
    updateNovisiblesquares(); // 更新未翻开格数
    return 0;
}
...
- 游戏结束后（踩雷或获胜）可选择：按 \`R\` 从难度选择重新开始，按其他任意键退出
- 翻开全部非雷格即获胜
- 每次选择难度后显示输入格式说明
...
const LEARNING_RESOURCES = {
  ...
  "daily-tools": [
    ...
    { name: "工具 123", url: "http://www.gjw123.com/", desc: "在线工具导航聚合站，收录上千个免安装小工具" },
  ...
  toolbox: {
    ...
    categories: [
      ...
      },
      {
        ...
        label: "实用工具",
        subItems: [],
        anchor: "section-res-daily-tools",
      },
      {
        id: "res-design",
        label: "设计素材",
        subItems: [],
        anchor: "section-res-design",
      },
      {
        id: "res-community",
        label: "技术社区",
        subItems: [],
        anchor: "section-res-community",
      },
      {
        id: "res-learning",
        label: "学习资料",
        subItems: [],
        anchor: "section-res-learning",
      },
    ],
  },
};
